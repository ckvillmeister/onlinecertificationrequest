...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-light" style="background-color: #196751">
    <div class="container">
      ...
      <a href="<?php echo ROOT; ?>" class="navbar-brand">
        <img src="<?php echo ROOT; ?>public/image/Trinidad_Logo.png" alt="TSIS Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
  ...
  <div class="imgbox">
    <img class="center-fit" src="<?php echo ROOT; ?>public/image/lineup.jpg">
  </div>
</div>  
