...
<div class="wrapper">
  ...
  <?php require 'app/views/components/sidebar.php'; ?>
          ...
          <div class="card">
            ...
            <div class="row p-3 shadow-none m-3 bg-light rounded">
              <div class="col-lg-12 align-self-center">
                <button class="btn btn-sm btn-primary" id="btn_new_faq" data-toggle="modal" data-target="#modal_faq_form"><icon class="fas fa-plus mr-2"></icon>New Item</button>
            ...
            <div id="faqs_list" class="mr-3 ml-3 mb-3">
            </div>
    ...
    <div class="modal fade" id="modal_faq_form" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modal_title">New Frequently Asked Question</h5>
          </div>
          <div class="modal-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-lg-9">
                  <input type="text" class="form-control form-control-sm" id="text_question">
              </div>
            </div>
            ...
            <div class="row mt-3">
              ...
              <div class="col-lg-9">
                <textarea class="form-control form-control-sm" id="text_answer"></textarea>
              </div>
            </div>
...
<script type="text/javascript" src="<?php echo ROOT.'public/js/faq.js'; ?>"></script>
</html>