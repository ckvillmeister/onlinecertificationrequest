  ...
  <?php require 'app/views/components/sidebar.php'; ?>
    ...
    <div class="content-wrapper">
        <div class="content-header">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Symptoms Checklist</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo ROOT; ?>main">Main</a></li>
                <li class="breadcrumb-item active">Symptoms Checklist</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="row p-3 shadow-none m-3 bg-light rounded">
              <div class="col-lg-12 align-self-center">
                <button class="btn btn-sm btn-primary" id="btn_new_item" data-toggle="modal" data-target="#modal_checklist_item_form"><icon class="fas fa-plus mr-2"></icon>New Item</button>
    ...
    <div class="modal fade" id="modal_checklist_item_form" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modal_title">New Checklist Item</h5>
          </div>
...
<script type="text/javascript" src="<?php echo ROOT.'public/js/checklist.js'; ?>"></script>
</html>